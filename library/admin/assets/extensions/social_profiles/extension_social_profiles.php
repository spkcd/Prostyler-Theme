        ...
        */
        public function __construct( $parent ) {
            ...
            if (!class_exists('reduxLoadSocialWidget')) {
	            // ------------------------------------------------------
	            //  yunus edit - disabled widget as we use our short tags => {social icons}
	            // ------------------------------------------------------
        ...
        public function save_me($saved_options = array(), $changed_values = array()) {
            ...
            //$data = apply_filters('redux/social_profiles/' . $this->parent->args['opt_name'] . '/live_save', $data, $changed_values);
